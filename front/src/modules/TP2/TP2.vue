...
<template>
  <div class="">
    <Form :model="customer" :resolver @submit="onFormSubmit" class="">
      <div class=" ">
  ...
  <div class="absolute end-4 bottom-4">
    <Button>
      <RouterLink to="/tp2-correction">Correction</RouterLink>
    </Button>
  </div>
</template>
