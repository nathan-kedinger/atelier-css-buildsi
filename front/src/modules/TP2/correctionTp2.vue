...
import {useCloseModal} from '../../composables/modalHandler'
...
<template>
        ...
        <div class="flex justify-between w-full ">
          ...
          <section class="mb-6 w-1/2">
            ...
            <div class="flex flex-row flex-wrap justify-around">
              ...
              <div class="flex flex-col gap-y-10 flew-wrap justify-around">
                <div>
  ...
  <div class="absolute end-4 bottom-4">
    <Button>
      <RouterLink to="/tp2">Exercice</RouterLink>
    </Button>
  </div>
</template>
